...
def test_account_event_staff_or_app_deleted_a_customer_event_resolves_properly(
    staff_api_client, staff_user, permission_manage_staff, permission_manage_apps
):
    event = account_events.staff_or_app_deleted_a_customer_event(
...
def test_event_staff_user_assigned_new_name_to_customer_event_resolves_properly(
    ...
    event = account_events.staff_or_app_assigned_name_to_a_customer_event(
...
def test_account_event_staff_user_assigned_email_to_customer_event_resolves_properly(
    ...
    event = account_events.staff_or_app_assigned_email_to_a_customer_event(
