...
_DEFAULT_CLIENT_HOSTS = "localhost,127.0.0.1,poc-market.herokuapp.com"
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,poc-market.herokuapp.com"))
